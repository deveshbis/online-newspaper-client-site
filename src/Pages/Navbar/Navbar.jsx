        ...
        <div className="navbar w-full  text-black  top-0 start-0 shadow-lg">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className={`menu menu-sm dropdown-content mt-3 z-[1060] p-2 shadow text-black bg-white rounded-box w-52 `}>
                        {navLinks}
                    </ul>
                </div>
                {/* <Link to='/'><img src={navBarLogo} className="h-16" /></Link> */}
                <Link to='/' className="btn btn-ghost lg:text-2xl md:texxl text-xs text-black">Newspaper Website</Link>
            </div>
