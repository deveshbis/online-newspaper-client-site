            ...
            <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        <div className="flex justify-center items-center text-teal-600 sm:justify-start">
                            <img src="./newspaper.png" alt="" className="h-10" />
                            <h2 className="text-2xl font-bold">Newspaper Online</h2>
                        </div>

                        <p className="mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left">
                            Essential for navigation and information, containing links like About Us, Contact, Privacy Policy, and Terms of Service.
                        </p>
                            ...
                            <ul className="mt-8 space-y-4 text-sm">
                                <li>
                                    ...
                                    >
                                        ...
                                        <span className="flex-1 text-gray-700">dev.cse@gmail.com</span>
                                    </a>
                                </li>
                ...
                <div className="mt-12 border-t border-gray-100 pt-6">
                    <div className="text-center sm:flex sm:justify-between sm:text-left">
                        ...
                        <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; 2024 Newspaper Online</p>
                    </div>
                </div>
            </div>
        </footer >
