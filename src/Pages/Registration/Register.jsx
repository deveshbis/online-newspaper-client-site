...
//                                         Password must contain at least one capital letter, one special character, and one numeric character
//                                     </span>
//                                 )}
//                             </div>
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} action="#" className="mt-8 grid grid-cols-6 gap-6">
                                ...
                                <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                                    ...
                                    <p className="mt-4 text-sm text-gray-500 sm:mt-0 flex gap-2">
                                        Already have an account?
                                        <Link to='/login'><p href="#" className="text-gray-700 underline">Log in</p></Link>
                                    </p>
                                </div>
                            </form>
                        </div>
